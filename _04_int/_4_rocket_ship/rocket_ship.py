...
def mouse_pressed(event):
    ...
    canvas.create_oval(x-47, y+50, x+47, y+170, fill='red')
    canvas.create_oval(x-45, y+60, x+45, y+160, fill='orange')
    canvas.create_oval(x-40, y+50, x+40, y+150, fill='yellow')
